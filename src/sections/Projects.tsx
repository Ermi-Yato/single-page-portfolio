    ...
    <div className="container lg:max-w-5xl pb-10 lg:pt-24">
      ...
      <div className="flex flex-col gap-16 mt-10 md:mt-20">
        {portfolioProjects.map(project => (
          <CardComponent key={project.title} className="relative overflow-x-clip bg-gray-800 border border-gray-500 rounded-[25px] px-8 pt-8 md:px-10 md:pt-12 lg:px-16 lg:pt-16">
